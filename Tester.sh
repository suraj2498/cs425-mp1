...
#*
#* Current file: Tester.sh
#* About this file: Local Testing Script.
#* 
#***********************
#!/bin/sh
...
echo "Estimated overall grade: $grade out of $max_grade"

echo 'Remember that this script has not submitted your work for a grade!'
echo 'You still need to use the submit.py script to submit your work for real.'
echo 'You can run it with: python3 ./submit.py'
